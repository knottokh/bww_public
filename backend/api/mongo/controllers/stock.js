...
const SelectModel = require("../models/stock");

exports.get_stock_types = (req, res, next) => {
    ShareController.get_distinct(res, SelectModel, 'stock_type', null, (results) => {
        res.status(200).json(results);
    });
}

exports.get_units = (req, res, next) => {
    ShareController.get_distinct(res, SelectModel, 'unit', null, (results) => {
        res.status(200).json(results);
    });
}
