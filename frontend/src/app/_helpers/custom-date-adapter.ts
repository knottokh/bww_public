...
/** Configurable options for {@see MomentDateAdapter}. */
 interface NgxMatMomentDateAdapterOptions {
...
/** InjectionToken for moment date adapter to configure options. */
 const MAT_MOMENT_DATE_ADAPTER_OPTIONS = new InjectionToken<NgxMatMomentDateAdapterOptions>(
...
/** @docs-private */
function MAT_MOMENT_DATE_ADAPTER_OPTIONS_FACTORY(): NgxMatMomentDateAdapterOptions {
  return {
    useUtc: false
  };
}
